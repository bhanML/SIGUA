    ...
    def __init__(self, root, train=True, transform=None, target_transform=None, download=False,
        ...
        if self.train:
            ...
            if noise_type != 'clean':
                ...
                self.train_noisy_labels, self.actual_noise_rate, self.P = noisify(dataset=self.dataset, train_labels=self.train_labels, noise_type=noise_type, noise_rate=noise_rate, random_state=random_state)
